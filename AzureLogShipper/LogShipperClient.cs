...
namespace AzureLogShipper
{
    ...
    public sealed class LogShipperClient : IDisposable
    {
            ...
            string body, byte[] bodyBytes, string dateString, string logType)
        {
            ...
            var signature = BuildHmacSignature(bodyBytes, dateString, _options.SharedKey);
        ...
        private static string BuildHmacSignature(byte[] bodyBytes, string dateString, string sharedKey)
        {
